...
NUMERIC_KEYS = {"width", "aspect_ratio", "thickness", "border_radius"}
STRING_KEYS = {"orientation"}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build a substrate from flat YAML values.")
...
def write_scad(values: dict[str, Any], model_name: str, out_path: Path) -> None:
    lines = [
        "// Generated by models/substrate/scripts/build.py",
...
def main() -> int:
    ...
    try:
        ...
        scad_out = args.out_dir / "substrate.scad"
        stl_out = args.out_dir / "substrate.stl"
